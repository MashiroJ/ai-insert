...
```bash
npm install -g ./ui-inspect-protocol-0.1.14.tgz ./ui-inspect-server-0.1.14.tgz ./ui-inspect-cli-0.1.14.tgz
npm install -D ./ui-inspect-protocol-0.1.14.tgz ./ui-inspect-vite-plugin-0.1.14.tgz
```
