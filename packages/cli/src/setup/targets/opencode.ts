...
function opencodeConfigPath(project: string): string {
...
function writeOpenCodeMcp(file: string, dryRun: boolean, changes: Array<{ file: string; action: 'created' | 'updated' | 'skipped' | 'planned'; description: string }>): void {
