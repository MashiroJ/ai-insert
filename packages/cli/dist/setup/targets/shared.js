...
export function createAgentResult(agent, detected) {
    return {
        agent,
        detected,
        mcpConfigured: false,
...
export function mergeJsonFile(file, dryRun, mutate, changes, description) {
...
export function appendTomlBlock(file, dryRun, marker, block, changes, description) {
    const existed = existsSync(file);
...
export function ensureHookScript(project, dryRun, changes) {
